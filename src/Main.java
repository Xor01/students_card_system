...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        do {
            ...
            System.out.println(aStudentExist() ? STUDENT_ARRAY_LIST.get(currentStudent).getId() : "None");
            System.out.println(
    ...
    private static void createStudent() {
        ...
        STUDENT_ARRAY_LIST
                .add(new Student(studentDetailsArray[0], studentDetailsArray[1], studentDetailsArray[2], temp));
        currentStudent += 1;
